...
- [ ] **Phase 4: Métricas Financeiras** — Cards de receita/despesa + gráfico visual
- [ ] **Phase 5: Rankings & Insights** — Rankings de serviços + insights de clientes
- [ ] **Phase 6: Disponibilidade & Ocupação** — Grid semanal por serviço + taxa de ocupação
- [ ] **Phase 7: Retenção de Clientes** — Frequência de retorno + estágios do ciclo de vida

## Phase Details

### Phase 4: Métricas Financeiras
...
### Phase 6: Disponibilidade & Ocupação
...
| 4. Métricas Financeiras | v4.0 | 0/0 | Not started | - |
| 5. Rankings & Insights | v4.0 | 0/0 | Not started | - |
| 6. Disponibilidade & Ocupação | v4.0 | 0/0 | Not started | - |
| 7. Retenção de Clientes | v4.0 | 0/0 | Not started | - |
